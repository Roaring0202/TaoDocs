...
- [Getting Started](./introduction.md)
  ...
  - [Delegation Explanation](./delegation.md)
...
- [The Skills You'll Need](./baseline_skills.md)
  ...
  - [For Windows Users](./before_you_build.md)
  - [Linux Basics](./Linux_basics.md)
  - [A Guide to Writing Documentation](./md_book.md)
...
- [Information for Validation](./generate_signature.md)
  ...
  - [What is Consensus?](./consensus.md)

- [Fine Tuning Examples/Mining](./Fine_tuning.md)
  - [Base Mining Models?](./mining_models.md)
  - [What's an Epoch?](./epochs.md)
  - [Miner Commands](./miner_commands.md)
  - [Analysis of a Miner Template](./miner_analysis.md)
  - [Cuda PoW](./Why_Cuda.md)
